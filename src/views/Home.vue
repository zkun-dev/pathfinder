  ...
  <div class="relative min-h-screen w-full overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 pt-20 md:pt-16">
      ...
      <template v-else-if="profile">
        ...
        <!-- 关于我 -->
        <section id="关于我" class="pt-6 scroll-mt-24">
          <div class="max-w-6xl mx-auto">
            <Footer :name="profile.name" :social-links="socialLinks" />
          </div>
        </section>
      </template>
    </div>
...
const ThreeDBackground = defineAsyncComponent(() => import('@/components/ThreeDBackground.vue'))
...
const fetchData = async () => {
  try {
    ...
    // 并行获取所有数据
    const [profileData, skillsData, projectsData, experiencesData, learningsData, lifeData] =
      await Promise.all([
